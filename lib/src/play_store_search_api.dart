...
class PlayStoreSearchAPI {
  ...
  Future<Document?> lookupById(String id,
    ...
    if (debugLogging) {
      print('AppUpgrader: lookupById url: $url');
    }
    ...
    try {
      ...
      if (response.statusCode < 200 || response.statusCode >= 300) {
        if (debugLogging) {
          print(
              'AppUpgrader: Can\'t find an app in the Play Store with the id: $id');
        }
        return null;
      }
...
extension PlayStoreResults on PlayStoreSearchAPI {
  ...
  String? redesignedDescription(Document response) {
    try {
      ...
      if (debugLogging) {
        print('AppUpgrader: PlayStoreResults.redesignedDescription exception: $e');
      }
    }
    return null;
  }
  ...
  Version? minAppVersion(
    ...
    try {
      ...
      if (desc != null) {
        ...
        if (mav != null) {
          try {
            ...
            if (debugLogging) {
              print(
                  'AppUpgrader: PlayStoreResults.minAppVersion: mav=$mav, tag=$tagRegExpSource, error=$e');
            }
          }
        }
      }
      ...
      if (debugLogging) {
        print('AppUpgrader.PlayStoreResults.minAppVersion : $e');
      }
    }
    return version;
  }
  ...
  String? redesignedReleaseNotes(Document response) {
    try {
      ...
      if (debugLogging) {
        print(
            'AppUpgrader: PlayStoreResults.redesignedReleaseNotes exception: $e');
      }
    }
    return null;
  }
  ...
  String? redesignedVersion(Document response) {
    ...
    try {
      ...
      if (debugLogging) {
        print('AppUpgrader: PlayStoreResults.redesignedVersion exception: $e');
      }
    }
