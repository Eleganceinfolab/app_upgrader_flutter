...
class Appcast {
      ...
      if (item.hostSupportsItem(
        ...
        if (bestItem == null) {
          ...
          try {
            ...
            print('AppUpgrader: criticalUpdateItem invalid version: $e');
          }
        }
      }
    });
      ...
      if (item.hostSupportsItem(
        ...
        if (bestItem == null) {
          ...
          try {
            ...
            print('AppUpgrader: bestItem invalid version: $e');
          }
        }
      }
    });
  ...
  Future<List<AppcastItem>?> parseAppcastItemsFromUri(String appCastURL) async {
    ...
    try {
      ...
      print('AppUpgrader: parseAppcastItemsFromUri exception: $e');
      return null;
    }
  ...
  List<AppcastItem>? parseItemsFromXMLString(String xmlString) {
    ...
    try {
      ...
      print('AppUpgrader: parseItemsFromXMLString exception: $e');
    }
  ...
  bool hostSupportsItem({String? osVersion, required String currentPlatform}) {
    ...
    if (supported && osVersion != null && osVersion.isNotEmpty) {
      ...
      try {
        ...
        print('AppUpgrader: hostSupportsItem invalid osVersion: $e');
        return false;
      }
      if (maximumSystemVersion != null) {
        try {
          ...
          print(
              'AppUpgrader: hostSupportsItem invalid maximumSystemVersion: $e');
        }
      }
      if (supported && minimumSystemVersion != null) {
        try {
          ...
          print(
              'AppUpgrader: hostSupportsItem invalid minimumSystemVersion: $e');
        }
      }
    }
    return supported;
