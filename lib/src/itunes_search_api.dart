...
class ITunesSearchAPI {
  ...
  Future<Map?> lookupByBundleId(String bundleId,
    ...
    if (debugLogging) {
      print('AppUpgrader: download: $url');
    }

    try {
      final response = await client!.get(Uri.parse(url));
      if (debugLogging) {
        print('AppUpgrader: response statusCode: ${response.statusCode}');
      }
      ...
      if (debugLogging) {
        print('AppUpgrader: lookupByBundleId exception: $e');
      }
      return null;
    }
  }
  ...
  Future<Map?> lookupById(String id,
    ...
    try {
      ...
      if (debugLogging) {
        print('AppUpgrader: lookupById exception: $e');
      }
      return null;
    }
  }
    ...
    if (jsonResponse.isNotEmpty) {
      ...
      if (decodedResults is Map) {
        ...
        if (resultCount == 0) {
          if (debugLogging) {
            print(
                'AppUpgrader.ITunesSearchAPI: results are empty: $decodedResults');
          }
        }
        return decodedResults;
      }
...
extension ITunesResults on ITunesSearchAPI {
  ...
  String? bundleId(Map response) {
    ...
    try {
      ...
      if (debugLogging) {
        print('AppUpgrader.ITunesResults.bundleId: $e');
      }
    }
    return value;
  }
  ...
  String? currency(Map response) {
    ...
    try {
      ...
      if (debugLogging) {
        print('AppUpgrader.ITunesResults.currency: $e');
      }
    }
    return value;
  }
  ...
  String? description(Map response) {
    ...
    try {
      ...
      if (debugLogging) {
        print('AppUpgrader.ITunesResults.description: $e');
      }
    }
    return value;
  }
  ...
  Version? minAppVersion(Map response, {String tagName = 'mav'}) {
    ...
    try {
      ...
      if (desc != null) {
        ...
        if (mav != null) {
          try {
            ...
            if (debugLogging) {
              print(
                  'AppUpgrader: ITunesResults.minAppVersion: $tagName error: $e');
            }
          }
        }
      }
      ...
      if (debugLogging) {
        print('AppUpgrader.ITunesResults.minAppVersion : $e');
      }
    }
    return version;
  }
  ...
  String? releaseNotes(Map response) {
    ...
    try {
      ...
      if (debugLogging) {
        print('AppUpgrader.ITunesResults.releaseNotes: $e');
      }
    }
    return value;
  }
  ...
  String? trackViewUrl(Map response) {
    ...
    try {
      ...
      if (debugLogging) {
        print('AppUpgrader.ITunesResults.trackViewUrl: $e');
      }
    }
    return value;
  }
  ...
  String? version(Map response) {
    ...
    try {
      ...
      if (debugLogging) {
        print('AppUpgrader.ITunesResults.version: $e');
      }
    }
    return value;
  }
